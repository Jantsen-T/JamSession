...
//
//        UserController.sharedInstance.makeUserInDB(username: username, uuid: , location: location, bio: bio, instrument: instrument, experience: experience as! String) { result in
//            
//        }
//
//
